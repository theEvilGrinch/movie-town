...
class dle_template {
	...
	function compile($tpl) {
		...
		$this->copy_template = str_ireplace( "{category-icon}", '{THEME}/dleimages/no_icon.gif', $this->copy_template );
		$this->copy_template = str_ireplace( "{category-url}", '', $this->copy_template );
