...
if( !defined('DATALIFEENGINE') ) {
	...
	if ( $row['id'] AND  $perm ) {
		...
		$xfields = xfieldsload();
		//  TODO моя строка для вывода информации из своих доп. полей в head через engine/engine.php
    $myxfields = $row['xfields'];
    //  TODO моя строка для вывода информации из своих доп. полей в head через engine/engine.php END
